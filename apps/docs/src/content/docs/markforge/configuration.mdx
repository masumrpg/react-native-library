...
Generates a dedicated, unnumbered title page before the main document content:
...
Generates an isolated closing back cover card at the end of the document:
...
### Signatures & Approval Block (`signatureBlock`)
