...
- 🧩 **[60+ Component Catalog](https://react-native-library-docs.vercel.app/rn-ui/components)**
...
- **60+ Typed Components**: Forms, feedback, overlays, navigation, data display, and chat UI primitives.
...
### React Native CLI
```sh
bun add @masumdev/rn-ui react-native-reanimated react-native-worklets react-native-gesture-handler react-native-calendars
```
