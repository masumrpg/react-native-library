...
<body>
  <div class="container">
    ...
    <!-- Footer -->
    <footer>
      Generated by <a href="https://masum.dev/tscheck" target="_blank"><strong>@masumdev/tscheck</strong></a> v${escapeHtml(report.version || "0.1.0")} — TypeScript AST Engine & Policy Inspector
    </footer>
  </div>
