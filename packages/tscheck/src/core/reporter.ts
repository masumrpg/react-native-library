    ...
    <footer>
      <div class="author-card">
        ...
        <div class="author-links">
          ...
          <span>•</span>
          <a href="https://react-native-library-docs.vercel.app" target="_blank" rel="noopener noreferrer">Docs Portal</a>
        </div>
      </div>
      <div>
        Generated by <a href="https://react-native-library-docs.vercel.app/tscheck" target="_blank" style="color: var(--primary); font-weight: 600;">@masumdev/tscheck</a> v${escapeHtml(report.version || "0.2.3")} — TypeScript AST Engine
      </div>
    </footer>
  </div>
